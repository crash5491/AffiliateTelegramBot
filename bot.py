...
def start(update, context):
    ...
    context.bot.send_message(chat_id=-1001071476765, text="Hola! Este bot responde a los enlaces de amazon añadiendo un codigo de afiliado!")
...
def filterText(update, context):
    ...
    if start != -1:
        ...
        context.bot.send_message(chat_id=update.message.chat_id,reply_to_message_id=-1001071476765, text=newReferURL(pCode))
        context.bot.send_message(chat_id=-1001071476765,reply_to_message_id=update.message.message_id, text=newReferURL(pCode))
